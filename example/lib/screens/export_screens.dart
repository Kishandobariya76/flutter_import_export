              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    OutlinedButton(onPressed: () => onNavigate?.call('export_csv'), style: OutlinedButton.styleFrom(foregroundColor: AppTheme.textSecondary), child: const Text('Switch to CSV Export')),
                  ],
                ),
              ],
            ),
